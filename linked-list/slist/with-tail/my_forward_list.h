...
public:
    ...
    template <class TT>
    friend std::ostream& operator<<(std::ostream& os, const my_forward_list<TT>& list);
 ...
 */
template <class T>
my_list_node<T>* my_forward_list<T>::get_node_at(int idx)
{
    if (idx < 0 || idx >= size)
    {
 ...
 */
template <class T>
void my_forward_list<T>::assert_invariants()
{
...
template <class TT>
std::ostream& operator<<(std::ostream& os, const my_forward_list<TT>& list)
{
 ...
 */
template <class T>
void my_forward_list<T>::insert(int idx, T val)
{
    if (idx < 0 || idx > size)
    {
        throw std::out_of_range("index out of range");
 ...
 */
template <class T>
void my_forward_list<T>::push_back(T val)
{
    insert(size, val);
}
 ...
 */
template <class T>
void my_forward_list<T>::push_front(T val)
{
    insert(0, val);
}
 ...
 */
template <class T>
void my_forward_list<T>::erase(int idx)
{
    if (idx < 0 || idx >= size)
    {
        throw std::out_of_range("index out of range");
 ...
 */
template <class T>
T my_forward_list<T>::value_at(int idx)
{
    if (idx < 0 || idx >= size)
    {
        throw std::out_of_range("index out of range");
 ...
 */
template <class T>
T my_forward_list<T>::value_n_from_end(int n)
{
 ...
 */
template <class T>
void my_forward_list<T>::remove_value(T value)
{
    if (head != nullptr)
    {
        my_list_node<T>* n = head;
